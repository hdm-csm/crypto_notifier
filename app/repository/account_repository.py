...
class AccountRepository:
    ...
    def create(self, session: Session, platform: PlatformType, platform_user_id: str) -> Account:
        new_account = Account(
            platform=platform, platform_user_id=str(platform_user_id), created_at=datetime.now()
        )
